...
class kanamuon {
	public :
		...
		Float_t         Z_Parton_px[2];
		Float_t         Z_Parton_py[2];
		Float_t         Z_Parton_pz[2];
		Float_t         Z_Parton_E[2];
		Float_t         Z_Parton_pt[2];
		Float_t         Z_Parton_et[2];
		Float_t         Z_Parton_eta[2];
		Float_t         Z_Parton_theta[2];
		Float_t         Z_Parton_phi[2];
		Int_t           Z_Parton_charge[2];
		Float_t         Z_Parton_vx[2];
		Float_t         Z_Parton_vy[2];
		Float_t         Z_Parton_vz[2];
		Float_t         Z_Parton_y[2];
		Int_t           Z_Parton_Id[2];
		Float_t         Z_Lepton_px;
		Float_t         Z_Lepton_py;
		Float_t         Z_Lepton_pz;
		...
		Float_t         Z_Lepton_pt;
		Float_t         Z_Lepton_et;
		Float_t         Z_Lepton_eta;
		Float_t         Z_Lepton_theta;
		Float_t         Z_Lepton_phi;
		Int_t           Z_Lepton_charge;
		Float_t         Z_Lepton_vx;
		Float_t         Z_Lepton_vy;
		Float_t         Z_Lepton_vz;
		Float_t         Z_Lepton_y;
		...
		Float_t         Z_Met_y;
		Int_t           Z_Met_Id;
		Float_t         Z_TagQuark_px[2];
		Float_t         Z_TagQuark_py[2];
		Float_t         Z_TagQuark_pz[2];
		Float_t         Z_TagQuark_E[2];
		Float_t         Z_TagQuark_pt[2];
		Float_t         Z_TagQuark_et[2];
		Float_t         Z_TagQuark_eta[2];
		Float_t         Z_TagQuark_theta[2];
		Float_t         Z_TagQuark_phi[2];
		Int_t           Z_TagQuark_charge[2];
		Float_t         Z_TagQuark_vx[2];
		Float_t         Z_TagQuark_vy[2];
		Float_t         Z_TagQuark_vz[2];
		Float_t         Z_TagQuark_y[2];
		Int_t           Z_TagQuark_Id[2];
		Int_t           Z_nParton_Winclusive;
		Int_t           event_runNo;
		Int_t           event_evtNo;
		Int_t           event_lumi;
		Int_t           event_bunch;
		...
		TBranch        *b_Z_H_mass_gen;   //!
		TBranch        *b_Z_H_px_gen;   //!
		TBranch        *b_Z_H_py_gen;   //!
		TBranch        *b_Z_H_pz_gen;   //!
		TBranch        *b_Z_H_e_gen;   //!
		TBranch        *b_Z_H_pt_gen;   //!
		TBranch        *b_Z_H_et_gen;   //!
		TBranch        *b_Z_H_eta_gen;   //!
		TBranch        *b_Z_H_phi_gen;   //!
		TBranch        *b_Z_H_vx_gen;   //!
		TBranch        *b_Z_H_vy_gen;   //!
		TBranch        *b_Z_H_vz_gen;   //!
		TBranch        *b_Z_H_y_gen;   //!
		TBranch        *b_Z_H_Id_gen;   //!
		...
		TBranch        *b_Z_Parton_px;   //!
		TBranch        *b_Z_Parton_py;   //!
		TBranch        *b_Z_Parton_pz;   //!
		TBranch        *b_Z_Parton_E;   //!
		TBranch        *b_Z_Parton_pt;   //!
		TBranch        *b_Z_Parton_et;   //!
		TBranch        *b_Z_Parton_eta;   //!
		TBranch        *b_Z_Parton_theta;   //!
		TBranch        *b_Z_Parton_phi;   //!
		TBranch        *b_Z_Parton_charge;   //!
		TBranch        *b_Z_Parton_vx;   //!
		TBranch        *b_Z_Parton_vy;   //!
		TBranch        *b_Z_Parton_vz;   //!
		TBranch        *b_Z_Parton_y;   //!
		TBranch        *b_Z_Parton_Id;   //!
		TBranch        *b_Z_Lepton_px;   //!
		TBranch        *b_Z_Lepton_py;   //!
		TBranch        *b_Z_Lepton_pz;   //!
		TBranch        *b_Z_Lepton_E;   //!
		TBranch        *b_Z_Lepton_pt;   //!
		TBranch        *b_Z_Lepton_et;   //!
		TBranch        *b_Z_Lepton_eta;   //!
		TBranch        *b_Z_Lepton_theta;   //!
		TBranch        *b_Z_Lepton_phi;   //!
		TBranch        *b_Z_Lepton_charge;   //!
		TBranch        *b_Z_Lepton_vx;   //!
		TBranch        *b_Z_Lepton_vy;   //!
		TBranch        *b_Z_Lepton_vz;   //!
		TBranch        *b_Z_Lepton_y;   //!
		TBranch        *b_Z_Lepton_Id;   //!
		TBranch        *b_Z_Met_px;   //!
		TBranch        *b_Z_Met_py;   //!
		TBranch        *b_Z_Met_pz;   //!
		TBranch        *b_Z_Met_E;   //!
		...
		TBranch        *b_Z_Met_et;   //!
		TBranch        *b_Z_Met_eta;   //!
		TBranch        *b_Z_Met_theta;   //!
		TBranch        *b_Z_Met_phi;   //!
		TBranch        *b_Z_Met_charge;   //!
		TBranch        *b_Z_Met_vx;   //!
		TBranch        *b_Z_Met_vy;   //!
		TBranch        *b_Z_Met_vz;   //!
		TBranch        *b_Z_Met_y;   //!
		TBranch        *b_Z_Met_Id;   //!
		TBranch        *b_Z_TagQuark_px;   //!
		TBranch        *b_Z_TagQuark_py;   //!
		TBranch        *b_Z_TagQuark_pz;   //!
		TBranch        *b_Z_TagQuark_E;   //!
		TBranch        *b_Z_TagQuark_pt;   //!
		TBranch        *b_Z_TagQuark_et;   //!
		TBranch        *b_Z_TagQuark_eta;   //!
		TBranch        *b_Z_TagQuark_theta;   //!
		TBranch        *b_Z_TagQuark_phi;   //!
		TBranch        *b_Z_TagQuark_charge;   //!
		TBranch        *b_Z_TagQuark_vx;   //!
		TBranch        *b_Z_TagQuark_vy;   //!
		TBranch        *b_Z_TagQuark_vz;   //!
		TBranch        *b_Z_TagQuark_y;   //!
		TBranch        *b_Z_TagQuark_Id;   //!
		TBranch        *b_Z_nParton_Winclusive;   //!
...
void kanamuon::Init(TTree *tree)
{
	...
	fChain->SetBranchAddress("Z_H_mass_gen", &Z_H_mass_gen, &b_Z_H_mass_gen);
	fChain->SetBranchAddress("Z_H_px_gen", &Z_H_px_gen, &b_Z_H_px_gen);
	fChain->SetBranchAddress("Z_H_py_gen", &Z_H_py_gen, &b_Z_H_py_gen);
	fChain->SetBranchAddress("Z_H_pz_gen", &Z_H_pz_gen, &b_Z_H_pz_gen);
	fChain->SetBranchAddress("Z_H_e_gen", &Z_H_e_gen, &b_Z_H_e_gen);
	fChain->SetBranchAddress("Z_H_pt_gen", &Z_H_pt_gen, &b_Z_H_pt_gen);
	fChain->SetBranchAddress("Z_H_et_gen", &Z_H_et_gen, &b_Z_H_et_gen);
	fChain->SetBranchAddress("Z_H_eta_gen", &Z_H_eta_gen, &b_Z_H_eta_gen);
	fChain->SetBranchAddress("Z_H_phi_gen", &Z_H_phi_gen, &b_Z_H_phi_gen);
	fChain->SetBranchAddress("Z_H_vx_gen", &Z_H_vx_gen, &b_Z_H_vx_gen);
	fChain->SetBranchAddress("Z_H_vy_gen", &Z_H_vy_gen, &b_Z_H_vy_gen);
	fChain->SetBranchAddress("Z_H_vz_gen", &Z_H_vz_gen, &b_Z_H_vz_gen);
	fChain->SetBranchAddress("Z_H_y_gen", &Z_H_y_gen, &b_Z_H_y_gen);
	fChain->SetBranchAddress("Z_H_Id_gen", &Z_H_Id_gen, &b_Z_H_Id_gen);
	...
	fChain->SetBranchAddress("Z_Parton_px[2]", Z_Parton_px, &b_Z_Parton_px);
	fChain->SetBranchAddress("Z_Parton_py[2]", Z_Parton_py, &b_Z_Parton_py);
	fChain->SetBranchAddress("Z_Parton_pz[2]", Z_Parton_pz, &b_Z_Parton_pz);
	fChain->SetBranchAddress("Z_Parton_E[2]", Z_Parton_E, &b_Z_Parton_E);
	fChain->SetBranchAddress("Z_Parton_pt[2]", Z_Parton_pt, &b_Z_Parton_pt);
	fChain->SetBranchAddress("Z_Parton_et[2]", Z_Parton_et, &b_Z_Parton_et);
	fChain->SetBranchAddress("Z_Parton_eta[2]", Z_Parton_eta, &b_Z_Parton_eta);
	fChain->SetBranchAddress("Z_Parton_theta[2]", Z_Parton_theta, &b_Z_Parton_theta);
	fChain->SetBranchAddress("Z_Parton_phi[2]", Z_Parton_phi, &b_Z_Parton_phi);
	fChain->SetBranchAddress("Z_Parton_charge[2]", Z_Parton_charge, &b_Z_Parton_charge);
	fChain->SetBranchAddress("Z_Parton_vx[2]", Z_Parton_vx, &b_Z_Parton_vx);
	fChain->SetBranchAddress("Z_Parton_vy[2]", Z_Parton_vy, &b_Z_Parton_vy);
	fChain->SetBranchAddress("Z_Parton_vz[2]", Z_Parton_vz, &b_Z_Parton_vz);
	fChain->SetBranchAddress("Z_Parton_y[2]", Z_Parton_y, &b_Z_Parton_y);
	fChain->SetBranchAddress("Z_Parton_Id[2]", Z_Parton_Id, &b_Z_Parton_Id);
	fChain->SetBranchAddress("Z_Lepton_px", &Z_Lepton_px, &b_Z_Lepton_px);
	fChain->SetBranchAddress("Z_Lepton_py", &Z_Lepton_py, &b_Z_Lepton_py);
	fChain->SetBranchAddress("Z_Lepton_pz", &Z_Lepton_pz, &b_Z_Lepton_pz);
	fChain->SetBranchAddress("Z_Lepton_E", &Z_Lepton_E, &b_Z_Lepton_E);
	fChain->SetBranchAddress("Z_Lepton_pt", &Z_Lepton_pt, &b_Z_Lepton_pt);
	fChain->SetBranchAddress("Z_Lepton_et", &Z_Lepton_et, &b_Z_Lepton_et);
	fChain->SetBranchAddress("Z_Lepton_eta", &Z_Lepton_eta, &b_Z_Lepton_eta);
	fChain->SetBranchAddress("Z_Lepton_theta", &Z_Lepton_theta, &b_Z_Lepton_theta);
	fChain->SetBranchAddress("Z_Lepton_phi", &Z_Lepton_phi, &b_Z_Lepton_phi);
	fChain->SetBranchAddress("Z_Lepton_charge", &Z_Lepton_charge, &b_Z_Lepton_charge);
	fChain->SetBranchAddress("Z_Lepton_vx", &Z_Lepton_vx, &b_Z_Lepton_vx);
	fChain->SetBranchAddress("Z_Lepton_vy", &Z_Lepton_vy, &b_Z_Lepton_vy);
	fChain->SetBranchAddress("Z_Lepton_vz", &Z_Lepton_vz, &b_Z_Lepton_vz);
	fChain->SetBranchAddress("Z_Lepton_y", &Z_Lepton_y, &b_Z_Lepton_y);
	fChain->SetBranchAddress("Z_Lepton_Id", &Z_Lepton_Id, &b_Z_Lepton_Id);
	fChain->SetBranchAddress("Z_Met_px", &Z_Met_px, &b_Z_Met_px);
	fChain->SetBranchAddress("Z_Met_py", &Z_Met_py, &b_Z_Met_py);
	fChain->SetBranchAddress("Z_Met_pz", &Z_Met_pz, &b_Z_Met_pz);
	fChain->SetBranchAddress("Z_Met_E", &Z_Met_E, &b_Z_Met_E);
	fChain->SetBranchAddress("Z_Met_pt", &Z_Met_pt, &b_Z_Met_pt);
	fChain->SetBranchAddress("Z_Met_et", &Z_Met_et, &b_Z_Met_et);
	fChain->SetBranchAddress("Z_Met_eta", &Z_Met_eta, &b_Z_Met_eta);
	fChain->SetBranchAddress("Z_Met_theta", &Z_Met_theta, &b_Z_Met_theta);
	fChain->SetBranchAddress("Z_Met_phi", &Z_Met_phi, &b_Z_Met_phi);
	fChain->SetBranchAddress("Z_Met_charge", &Z_Met_charge, &b_Z_Met_charge);
	fChain->SetBranchAddress("Z_Met_vx", &Z_Met_vx, &b_Z_Met_vx);
	fChain->SetBranchAddress("Z_Met_vy", &Z_Met_vy, &b_Z_Met_vy);
	fChain->SetBranchAddress("Z_Met_vz", &Z_Met_vz, &b_Z_Met_vz);
	fChain->SetBranchAddress("Z_Met_y", &Z_Met_y, &b_Z_Met_y);
	fChain->SetBranchAddress("Z_Met_Id", &Z_Met_Id, &b_Z_Met_Id);
	fChain->SetBranchAddress("Z_TagQuark_px[2]", Z_TagQuark_px, &b_Z_TagQuark_px);
	fChain->SetBranchAddress("Z_TagQuark_py[2]", Z_TagQuark_py, &b_Z_TagQuark_py);
	fChain->SetBranchAddress("Z_TagQuark_pz[2]", Z_TagQuark_pz, &b_Z_TagQuark_pz);
	fChain->SetBranchAddress("Z_TagQuark_E[2]", Z_TagQuark_E, &b_Z_TagQuark_E);
	fChain->SetBranchAddress("Z_TagQuark_pt[2]", Z_TagQuark_pt, &b_Z_TagQuark_pt);
	fChain->SetBranchAddress("Z_TagQuark_et[2]", Z_TagQuark_et, &b_Z_TagQuark_et);
	fChain->SetBranchAddress("Z_TagQuark_eta[2]", Z_TagQuark_eta, &b_Z_TagQuark_eta);
	fChain->SetBranchAddress("Z_TagQuark_theta[2]", Z_TagQuark_theta, &b_Z_TagQuark_theta);
	fChain->SetBranchAddress("Z_TagQuark_phi[2]", Z_TagQuark_phi, &b_Z_TagQuark_phi);
	fChain->SetBranchAddress("Z_TagQuark_charge[2]", Z_TagQuark_charge, &b_Z_TagQuark_charge);
	fChain->SetBranchAddress("Z_TagQuark_vx[2]", Z_TagQuark_vx, &b_Z_TagQuark_vx);
	fChain->SetBranchAddress("Z_TagQuark_vy[2]", Z_TagQuark_vy, &b_Z_TagQuark_vy);
	fChain->SetBranchAddress("Z_TagQuark_vz[2]", Z_TagQuark_vz, &b_Z_TagQuark_vz);
	fChain->SetBranchAddress("Z_TagQuark_y[2]", Z_TagQuark_y, &b_Z_TagQuark_y);
	fChain->SetBranchAddress("Z_TagQuark_Id[2]", Z_TagQuark_Id, &b_Z_TagQuark_Id);
	fChain->SetBranchAddress("Z_nParton_Winclusive", &Z_nParton_Winclusive, &b_Z_nParton_Winclusive);
